...
public class FacadeComputer {
	...
	public void startup(){
		System.out.println("-----FacadeComputer is staring-----");
		cpu.startup();
		memory.startup();
		disk.startup();
		System.out.println("-----FacadeComputer is up-----");
	}
	
	public void shutdown(){
		System.out.println("-----FacadeComputer is shutting down-----");
		cpu.shutdown();
		memory.shutdown();
		disk.shutdown();
		System.out.println("-----FacadeComputer is down-----");
	}
